...
<template>
  <main id="main" class="mb-16">
    <section id="content pt-12">
      ...
      <p>
        Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the <NuxtLink class="text-custom1-500 underline" href="https://www.freeprivacypolicy.com/blog/sample-privacy-policy-template/#Use_Of_Cookies_And_Tracking" target="_blank">
      ...
      <ul class="ms-8 list-disc">
        <li>
          ...
          <p>
            Their Privacy Policy can be viewed at <NuxtLink class="text-custom1-500 underline" href="https://www.zoho.com/privacy.html" rel="external nofollow noopener" target="_blank">
      ...
      <ul class="ms-8 list-disc">
        <li>
          ...
          <p>
            Their Privacy Policy can be viewed at <NuxtLink class="text-custom1-500 underline" href="https://stripe.com/us/privacy" rel="external nofollow noopener" target="_blank">
      ...
      <ul class="ms-8 list-disc mt-6">
        ...
        <li>
          ...
          <ul class="ms-8 list-circle mt-6">
